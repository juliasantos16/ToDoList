...
icon_editar = PhotoImage(file="edit.png").subsample(3, 3)  # Ajuste conforme necessário
icon_deletar = PhotoImage(file="delete.png").subsample(3, 3)  # Ajuste conforme necessário
...
rotulo_cabecalho = tk.Label(janela, text="To do list App", font=fonte_cabecalho, bg="#F0F0F0", fg="#333")
